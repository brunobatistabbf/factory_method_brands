...
class camisaBrasil(camisaEsportiva):
    def InfoProduto(self):
        print("Time: Seleção Braileira")
        print("Cor: Amarela")
        print("Valor: R$ 102.90")

class camisaFlamengo(camisaEsportiva):
    def InfoProduto(self):
        print("Time: Flamengo")
        print("Cor: Vermelho, Preto")
        print("Valor: R$ 78.99")

class camisaBotafogo(camisaEsportiva):
    def InfoProduto(self):
        print("Time: Botafogo")
        print("Cor: Preto, Branco")
        print("Valor: R$ 66.45")

class camisaFluminense(camisaEsportiva):
    def InfoProduto(self):
        print("Time: Fluminenes")
        print("Cor: Vermelho, Verde, Branco")
        print("Valor: R$ 89.90")

class camisaVasco(camisaEsportiva):
    def InfoProduto(self):
        print("Time: Vasco")
        print("Cor: Branco, Preto")
        print("Valor: R$ 76.90")